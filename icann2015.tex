...
\begin{figure*}
\centering
	\includegraphics[width=0.9\textwidth]{pics/matlabrate1.pdf}
	\caption{Neural responses with time to the same recorded postures.}
	\label{fig:matlabrec}
\end{figure*}
...
\begin{table}
\centering
\caption{Recognition results on SpiNNaker in real time}
	\begin{tabular}{p{0.075\textwidth}|p{0.05\textwidth}<{\centering}|p{0.055\textwidth}<{\centering}|p{0.055\textwidth}<{\centering}|p{0.055\textwidth}<{\centering}|p{0.055\textwidth}<{\centering}}
		%Line 1
		\Xhline{1.2pt}
		...
		\multirow{2}{*}{\tabincell{l}{\textbf{Fist}}}
			...
			\\ \hline
		%Line 5-6
		\multirow{2}{*}{\tabincell{l}{\textbf{One Finger}}}
